...
export default function Funcionalidades() {
  ...
  return (
    <main id="main-content" style={{ backgroundColor: "var(--cv-ground)" }} className="booking-page text-ink min-h-screen overflow-hidden selection:bg-[var(--cv-amarelo)]">
      ...
      {/* PARA OS CLIENTES */}
      <section style={{ backgroundColor: "var(--cv-card)" }} className="relative py-20 lg:py-28 px-6 lg:px-12 border-t border-linha">
      ...
      <section className="relative py-20 lg:py-28 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {AINDA_NAO.map((c, i) => (
              <ScrollReveal key={c.titulo} delay={i * 0.06} variant="fadeInUp">
                <article className="h-full p-6 rounded-2xl bg-card border border-linha">
